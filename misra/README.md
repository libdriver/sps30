...
| 14.2      | Loop counter (i) should not be modified in the body of the loop | incompatible | Not defect， drivers guarantee the safety of the operation.  | very low |

### Report

Detailed reports can be found in /misra/sps30_polyspace_report.pdf.
